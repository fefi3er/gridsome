                ...
                <el-row>
                    ...
                    <el-col :span="4" style="text-align: right;">
                        ...
                        <div style="color:#606266;">
                            <i class="el-icon-location"></i>&nbsp;ShangHai
                            <br>
                        </div>
                    </el-col>
                    <el-col :span="2" style="text-align: center;">
                        <img v-popover:bigAvatar src="../../favicon.png" style="margin-top: 4px;margin-right: 10px;width:52px; height:52px; border-radius:5px; border: 1px solid #EBEEF5"
                        />
                        <el-popover ref="bigAvatar" placement="top-start" title="XYF-HOMEWORK" width="200" trigger="hover">
                            <i class="el-icon-star-on"></i>&emsp;XYF
                            <br>
                            <i class="el-icon-location"></i>&emsp;ShangHai
                            <br>
                            <img src="../../favicon.png" style="width: 200px;height: 200px;">
                        </el-popover>
                    </el-col>
                </el-row>
